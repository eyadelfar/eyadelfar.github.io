    ...
    createFrame(-6.92, 2.4, 0.4, Math.PI / 2, 'images/keepquill.webp', 0.78, 0.5, 'KeepQuill', { kind: 'page', src: 'portfolio.html?v=3#keepquill', title: 'KeepQuill - Sample Book & Readme', prompt: 'Press <b>E</b> to read the KeepQuill sample book' });
    ...
    createFrame(6.92, 2.55, 11.2, -Math.PI / 2, 'images/favisra.webp', 0.78, 0.5, 'Favisra', { kind: 'page', src: 'portfolio.html?v=3#favisra', title: 'Favisra - Live Dashboard (demo data)', prompt: 'Press <b>E</b> to open the Favisra dashboard' });
